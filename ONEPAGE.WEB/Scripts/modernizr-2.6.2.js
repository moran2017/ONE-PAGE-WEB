...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles && !data.hasCSS) {
          data.hasCSS = !!addStyleSheet(ownerDocument,
            ...
            'article,aside,figcaption,figure,footer,steaks1,hgroup,nav,section{display:block}' +
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi canvas data datalist details figcaption figure footer steaks1 hgroup mark meter nav output progress section summary time video',
